...
function Hero() {
  ...
  return (
    <div ref={heroRef} id='hero' className='w-full h-screen overflow-hidden relative bg-black'>
      <Image 
        src={`https://ilatorre7.github.io/gaia-box-gourmet-web/hero-image.png`}
      ...
      <div className='relative flex flex-col justify-center items-center h-full p-4'>
        <Image src={`https://ilatorre7.github.io/gaia-box-gourmet-web/logo-hero.png`} alt="Gaia Logo" width={442.5} height={442.5} className='image' />
